...
**Nothing is invented.** Family line entries, author notes, questions and order editions appear
...
| `TeamMember` | Our Team  | LaTanya D. Kelly-Douet Family Line | `/family-line` | `/admin/family-line` |
| `BlogPost`   | Journal   | eBook/Paperback Order   | `/ebook-order`  | `/admin/ebook-order`   |

The Family Line page also shows one header image, uploaded in Site settings. The fields kept
